...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Content
    ...
    {...props}
  >
    <div className={cn("pb-4 pt-2 animate-in fade-in-0", className)}>{children}</div>
  </AccordionPrimitive.Content>
));
