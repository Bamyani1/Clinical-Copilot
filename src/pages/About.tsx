...
const About = () => {
  ...
  return (
    <div className="flex w-full flex-col gap-24 sm:gap-28">
      {/* Hero */}
      <section className="group relative overflow-hidden rounded-[var(--radius-lg)] border border-primary-muted/45 bg-surface px-8 py-24 shadow-lg shadow-primary/8 hover:border-primary-muted/60 hover:shadow-xl hover:shadow-primary/12 sm:px-12 sm:py-28">
      ...
      <section className="group relative overflow-hidden rounded-[var(--radius-lg)] border border-primary-muted/40 bg-gradient-to-br from-surface via-surface to-primary-soft/5 px-8 py-20 shadow-lg shadow-primary/8 hover:border-primary-muted/55 hover:shadow-xl hover:shadow-primary/12 sm:px-12 sm:py-24">
        <div className="pointer-events-none absolute inset-0 opacity-0 group-hover:opacity-100">
        ...
        <div className="relative grid gap-12 lg:grid-cols-[minmax(0,260px)_minmax(0,1fr)] lg:items-start">
          ...
          <div className="grid gap-10">
            {principles.map((principle, index) => {
              ...
              return (
                <div key={principle.title} className="group/item relative pl-12 hover:translate-x-1">
                  <div className="pointer-events-none absolute left-0 top-0 h-full w-px bg-gradient-to-b from-primary/40 via-primary/20 to-transparent group-hover/item:from-primary/60 group-hover/item:via-primary/30" aria-hidden />
                  <div className="flex flex-col gap-3">
                    <div className="flex items-center gap-4">
                      <div className="flex h-10 w-10 items-center justify-center rounded-[var(--radius)] bg-primary text-white shadow-sm group-hover/item:scale-105">
                        <Icon className="h-5 w-5 group-hover/item:scale-110" />
                      </div>
                      <h3 className="text-lg font-semibold text-foreground group-hover/item:text-primary">
                        {principle.title}
                      </h3>
                    </div>
      ...
      {/* Workflow */}
      <section className="group relative overflow-hidden rounded-[var(--radius-lg)] border border-primary-muted/40 bg-surface px-8 py-20 hover:border-primary-muted/55 sm:px-12 sm:py-24">
        <div className="pointer-events-none absolute inset-0 opacity-0 group-hover:opacity-100">
        ...
        <div className="relative mt-12">
          <div className="grid gap-4 md:grid-cols-2 lg:gap-5">
            {workflowSteps.map((step, index) => (
              <div
                key={step.title}
                className="group/step relative overflow-hidden rounded-lg border border-border/40 bg-background/60 hover:border-primary/40 hover:bg-background/80"
              >
                <div className="absolute left-0 top-0 h-full w-1 bg-gradient-to-b from-primary/60 to-primary/20" />
                <div className="flex gap-4 p-5">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-md bg-primary/10 text-primary group-hover/step:bg-primary/20">
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <h3 className="text-base font-semibold text-foreground group-hover/step:text-primary">
                      {step.title}
                    </h3>
